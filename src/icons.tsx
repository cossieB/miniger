...
export function PlayListSvg(props: Props) {
    return (
        //@ts-expect-error
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-down" viewBox="0 0 16 16" {...props}>
...
export function Eraser(props: Props) {
    return (
        //@ts-expect-error
